...
class acf
{
	...
	*/
	...
	{
		// incudes
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/api.php');
		
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/controllers/input.php');
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/controllers/location.php');
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/controllers/field_group.php');
		
		
		// admin only includes
		if( is_admin() )
		{
			include_once(get_template_directory() . '/lib/advanced-custom-fields/core/controllers/post.php');
			include_once(get_template_directory() . '/lib/advanced-custom-fields/core/controllers/revisions.php');
			include_once(get_template_directory() . '/lib/advanced-custom-fields/core/controllers/everything_fields.php');
			include_once(get_template_directory() . '/lib/advanced-custom-fields/core/controllers/field_groups.php');
		}
		
		
		// register fields
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/fields/_functions.php');
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/fields/_base.php');
		
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/fields/text.php');
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/fields/textarea.php');
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/fields/number.php');
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/fields/email.php');
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/fields/password.php');
		
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/fields/wysiwyg.php');
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/fields/image.php');
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/fields/file.php');
		
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/fields/select.php');
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/fields/checkbox.php');
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/fields/radio.php');
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/fields/true_false.php');
		
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/fields/page_link.php');
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/fields/post_object.php');
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/fields/relationship.php');
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/fields/taxonomy.php');
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/fields/user.php');
		
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/fields/google-map.php');
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/fields/date_picker/date_picker.php');
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/fields/color_picker.php');
		
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/fields/message.php');
		include_once(get_template_directory() . '/lib/advanced-custom-fields/core/fields/tab.php');
	...
	*/
	...
	function include_after_theme() {
		...
		if( is_admin() )
		{
			include_once(get_template_directory() . '/lib/advanced-custom-fields/core/controllers/export.php');
			include_once(get_template_directory() . '/lib/advanced-custom-fields/core/controllers/addons.php');
			include_once(get_template_directory() . '/lib/advanced-custom-fields/core/controllers/third_party.php');
			include_once(get_template_directory() . '/lib/advanced-custom-fields/core/controllers/upgrade.php');
		}
